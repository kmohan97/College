...
public class Fee_admin extends HttpServlet
{
Connection cn;
...
RequestDispatcher rd2=req.getRequestDispatcher("fee_admin.html");
rd2.include(req,res);

}else{
out.println("Please Renter the data");

RequestDispatcher rd=req.getRequestDispatcher("fee_admin.html");
rd.include(req,res);
}
}catch(Exception ee)
{
