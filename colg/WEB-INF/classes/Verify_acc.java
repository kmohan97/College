...
public class Verify_acc extends HttpServlet
{
Connection cn;
...
RequestDispatcher rd2=req.getRequestDispatcher("verify_acc.html");
rd2.include(req,res);

}else{
out.println("Please Renter the data");

RequestDispatcher rd=req.getRequestDispatcher("verify_acc.html");
rd.include(req,res);
}
}catch(Exception ee)
{
