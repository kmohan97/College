...
public class Allfee_acc extends HttpServlet
{
Connection cn;
...
ps=cn.prepareStatement(" Select * from stud12 where fee=(?)");
//s=cn.createStatement();
}catch(Exception ee)
{
ee.printStackTrace();
...
RequestDispatcher rd2=req.getRequestDispatcher("allfee_acc.html");
rd2.include(req,res);

}else{
out.println("Please Renter the data");

RequestDispatcher rd=req.getRequestDispatcher("allfee_acc.html");
rd.include(req,res);
}
}catch(Exception ee)
{
