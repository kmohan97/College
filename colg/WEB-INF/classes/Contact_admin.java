...
public class Contact_admin extends HttpServlet
{
Connection cn;
...
RequestDispatcher rd2=req.getRequestDispatcher("contact_admin.html");
rd2.include(req,res);

}else{
out.println("Please Renter the data");

RequestDispatcher rd=req.getRequestDispatcher("contact_admin.html");
rd.include(req,res);
}
}catch(Exception ee)
{
